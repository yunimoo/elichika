...
type FetchBootstrapResponse struct {
	...
	FetchBootstrapNewBadgeResponse     client.BootstrapNewBadge     `json:"fetch_bootstrap_new_badge_response"`    // TODO(not_really_handled)
	...
	FetchBootstrapExpiredItemResponse  client.BootstrapExpiredItem  `json:"fetch_bootstrap_expired_item_response"` // TODO(not_really_handled)
	FetchBootstrapLoginBonusResponse   client.BootstrapLoginBonus   `json:"fetch_bootstrap_login_bonus_response"`
	FetchBootstrapNoticeResponse       client.BootstrapNotice       `json:"fetch_bootstrap_notice_response"`       // TODO(not_really_handled)
