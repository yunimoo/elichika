...
// for unique items like Wish / Radiance, the type is model.Content
// for items with similar one like memorial / memento then it might be a map or a builder or whatever
// after obtaining the model.Content, use Amount() to set the amount, but the amount is defaulted to 1 if not set
