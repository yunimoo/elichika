...
type UserModelCommon struct {
	...
	UserStoryMainByStoryMainID                                                 generic.ObjectByObjectID[int]                            `json:"user_story_main_by_story_main_id"`               // TODO: not properly handled
	UserStoryMainSelectedByStoryMainCellID                                     generic.ObjectByObjectID[int]                            `json:"user_story_main_selected_by_story_main_cell_id"` // TODO: not properly handled
	UserVoiceByVoiceID                                                         generic.ObjectByObjectID[int]                            `json:"user_voice_by_voice_id"`                         // TODO: not properly handled
	UserEmblemByEmblemID                                                       generic.ObjectByObjectID[int]                            `json:"user_emblem_by_emblem_id"`                       // TODO: not properly handled
	UserGachaTicketByTicketID                                                  generic.ObjectByObjectID[int]                            `json:"user_gacha_ticket_by_ticket_id"`                 // TODO: not properly handled
	UserGachaPointByPointID                                                    generic.ObjectByObjectID[int]                            `json:"user_gacha_point_by_point_id"`                   // TODO: not properly handled
	UserLessonEnhancingItemByItemID                                            generic.ObjectByObjectID[int]                            `json:"user_lesson_enhancing_item_by_item_id"`          // TODO: not properly handled
	UserTrainingMaterialByItemID                                               generic.ObjectByObjectID[int]                            `json:"user_training_material_by_item_id"`              // TODO: not properly handled
	UserGradeUpItemByItemID                                                    generic.ObjectByObjectID[int]                            `json:"user_grade_up_item_by_item_id"`                  // TODO: not properly handled
	UserCustomBackgroundByID                                                   generic.ObjectByObjectID[int]                            `json:"user_custom_background_by_id"`                   // TODO: not properly handled
	UserStorySideByID                                                          generic.ObjectByObjectID[int]                            `json:"user_story_side_by_id"`                          // TODO: not properly handled
	UserStoryMemberByID                                                        generic.ObjectByObjectID[int]                            `json:"user_story_member_by_id"`                        // TODO: not properly handled
	...
	UserStoryEventHistoryByID                                                  generic.ObjectByObjectID[int]                            `json:"user_story_event_history_by_id"`                 // TODO: not properly handled
	UserRecoveryLpByID                                                         generic.ObjectByObjectID[int]                            `json:"user_recovery_lp_by_id"`                         // TODO: not properly handled
	UserRecoveryApByID                                                         generic.ObjectByObjectID[int]                            `json:"user_recovery_ap_by_id"`                         // TODO: not properly handled
	...
	UserAccessoryLevelUpItemByID                                               generic.ObjectByObjectID[int]                            `json:"user_accessory_level_up_item_by_id"`                                                       // TODO: not properly handled
	UserAccessoryRarityUpItemByID                                              generic.ObjectByObjectID[int]                            `json:"user_accessory_rarity_up_item_by_id"`                                                       // TODO: not properly handled
	UserUnlockScenesByEnum                                                     generic.ObjectByObjectID[int]                            `json:"user_unlock_scenes_by_enum"`                                                                // TODO: not properly handled
	UserSceneTipsByEnum                                                        generic.ObjectByObjectID[int]                            `json:"user_scene_tips_by_enum"`                                                                   // TODO: not properly handled
	UserRuleDescriptionByID                                                    generic.ObjectByObjectID[int]                            `json:"user_rule_description_by_id"`                                                               // TODO: not properly handled
	UserExchangeEventPointByID                                                 generic.ObjectByObjectID[int]                            `json:"user_exchange_event_point_by_id"`                                                           // TODO: not properly handled
	...
	UserLiveSkipTicketByID                                                     generic.ObjectByObjectID[int]                            `json:"user_live_skip_ticket_by_id"`                                                               // TODO: not properly handled
	UserStoryEventUnlockItemByID                                               generic.ObjectByObjectID[int]                            `json:"user_story_event_unlock_item_by_id"`                                                        // TODO: not properly handled
	...
	UserReferenceBookByID                                                      generic.ObjectByObjectID[int]                            `json:"user_reference_book_by_id"`                                                                 // TODO: not properly handled
	...
	UserStoryLinkageByID                                                       generic.ObjectByObjectID[int]                            `json:"user_story_linkage_by_id"`                                                                  // TODO: not properly handled
	UserSubscriptionStatusByID                                                 generic.ObjectByObjectID[int]                            `json:"user_subscription_status_by_id"`                                                            // TODO: not properly handled
	UserStoryMainPartDigestMovieByID                                           generic.ObjectByObjectID[int]                            `json:"user_story_main_part_digest_movie_by_id"`                                                   // TODO: not properly handled
	...
	UserPlayListByID                                                           generic.ObjectByObjectID[model.UserPlayListItem]         `json:"user_play_list_by_id"`                                                                      // TODO: not properly handled
	UserSetProfileByID                                                         generic.ObjectByObjectID[model.UserSetProfile]           `json:"user_set_profile_by_id"`                                                                    // TODO: not properly handled
