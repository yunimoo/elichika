...
type UserModel struct {
	...
	UserLiveMvDeckByID                                                         generic.ObjectByObjectIDList[model.UserLiveMvDeck]               `json:"user_live_mv_deck_by_id"`        // TODO: not properly handled
	UserLiveMvDeckCustomByID                                                   generic.ObjectByObjectIDList[model.UserLiveMvDeck]               `json:"user_live_mv_deck_custom_by_id"` // TODO: not properly handled
	...
	UserGachaTicketByTicketID                                                  generic.ObjectByObjectIDList[int]                                `json:"user_gacha_ticket_by_ticket_id"` // TODO: not properly handled
	...
	UserCustomBackgroundByID                                                   generic.ObjectByObjectIDList[model.UserCustomBackground]         `json:"user_custom_background_by_id"` // TODO: not properly handled
	...
	UserCommunicationMemberDetailBadgeByID                                     generic.ObjectByObjectIDList[int]                                `json:"user_communication_member_detail_badge_by_id"` // TODO: not properly handled
	...
	UserMissionByMissionID                                                     generic.ObjectByObjectIDList[int]                                `json:"user_mission_by_mission_id"`        // TODO: not properly handled
	UserDailyMissionByMissionID                                                generic.ObjectByObjectIDList[int]                                `json:"user_daily_mission_by_mission_id"`  // TODO: not properly handled
	UserWeeklyMissionByMissionID                                               generic.ObjectByObjectIDList[int]                                `json:"user_weekly_mission_by_mission_id"` // TODO: not properly handled
	...
	UserInfoTriggerMemberGuildSupportItemExpiredByTriggerID                    generic.ObjectByObjectIDList[int]                                `json:"user_info_trigger_member_guild_support_item_expired_by_trigger_id"` // TODO: not properly handled
	...
	UserSchoolIdolFestivalIDRewardMissionByID                                  generic.ObjectByObjectIDList[int]                                `json:"user_school_idol_festival_id_reward_mission_by_id"` // TODO: not properly handled
	UserGpsPresentReceivedByID                                                 generic.ObjectByObjectIDList[int]                                `json:"user_gps_present_received_by_id"`                   // TODO: not properly handled
	UserEventMarathonByEventMasterID                                           generic.ObjectByObjectIDList[int]                                `json:"user_event_marathon_by_event_master_id"`            // TODO: not properly handled
	UserEventMiningByEventMasterID                                             generic.ObjectByObjectIDList[int]                                `json:"user_event_mining_by_event_master_id"`              // TODO: not properly handled
	UserEventCoopByEventMasterID                                               generic.ObjectByObjectIDList[int]                                `json:"user_event_coop_by_event_master_id"`                // TODO: not properly handled
	...
	UserEventMarathonBoosterByID                                               generic.ObjectByObjectIDList[int]                                `json:"user_event_marathon_booster_by_id"` // TODO: not properly handled
	UserReferenceBookByID                                                      generic.ObjectByObjectIDList[model.UserReferenceBook]            `json:"user_reference_book_by_id"`
	UserReviewRequestProcessFlowByID                                           generic.ObjectByObjectIDList[int]                                `json:"user_review_request_process_flow_by_id"`                                                    // TODO: not properly handled
	UserTowerByTowerID                                                         generic.ObjectByObjectIDList[int]                                `json:"user_tower_by_tower_id"`                                                                    // TODO: not properly handled
	UserRecoveryTowerCardUsedCountItemByRecoveryTowerCardUsedCountItemMasterID generic.ObjectByObjectIDList[int]                                `json:"user_recovery_tower_card_used_count_item_by_recovery_tower_card_used_count_item_master_id"` // TODO: not properly handled
	UserStoryLinkageByID                                                       generic.ObjectByObjectIDList[model.UserStoryLinkage]             `json:"user_story_linkage_by_id"`
	UserSubscriptionStatusByID                                                 generic.ObjectByObjectIDList[int]                                `json:"user_subscription_status_by_id"` // TODO: not properly handled
	...
	UserMemberGuildByID                                                        generic.ObjectByObjectIDList[int]                                `json:"user_member_guild_by_id"`                // TODO: not properly handled
	UserMemberGuildSupportItemByID                                             generic.ObjectByObjectIDList[int]                                `json:"user_member_guild_support_item_by_id"`   // TODO: not properly handled
	UserDailyTheaterByDailyTheaterID                                           generic.ObjectByObjectIDList[int]                                `json:"user_daily_theater_by_daily_theater_id"` // TODO: not properly handled
	...
	UserSteadyVoltageRankingByID                                               generic.ObjectByObjectIDList[int]                                `json:"user_steady_voltage_ranking_by_id"` // TODO: not properly handled
	UserSif2DataLinkByID                                                       generic.ObjectByObjectIDList[int]                                `json:"user_sif_2_data_link_by_id"`        // TODO: not properly handled
}
